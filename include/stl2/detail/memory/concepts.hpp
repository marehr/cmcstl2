...
STL2_OPEN_NAMESPACE {
	...
	//
	template <class I>
	STL2_CONCEPT_KEYWORD __NoThrowInputIterator =
		InputIterator<I> &&
	...
	STL2_CONCEPT_KEYWORD __NoThrowSentinel =
		Sentinel<S, I>;
	...
	//
	template <class Rng>
	STL2_CONCEPT_KEYWORD __NoThrowInputRange =
		Range<Rng> &&
	...
	//
	template <class I>
	STL2_CONCEPT_KEYWORD __NoThrowForwardIterator =
	...
	//
	template <class Rng>
	STL2_CONCEPT_KEYWORD __NoThrowForwardRange =
