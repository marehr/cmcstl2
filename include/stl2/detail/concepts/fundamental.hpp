...
STL2_OPEN_NAMESPACE {
	...
	namespace ext {
		template <class T>
		STL2_CONCEPT_KEYWORD Arithmetic =
	...
	namespace ext {
		template <class T>
		STL2_CONCEPT_KEYWORD FloatingPoint =
	...
	//
	template <class T>
	STL2_CONCEPT_KEYWORD SignedIntegral =
		Integral<T> && (T(-1) < T(0));
	...
	//
	template <class T>
	STL2_CONCEPT_KEYWORD UnsignedIntegral =
