...
STL2_OPEN_NAMESPACE {
	...
	STL2_CONCEPT_KEYWORD Invocable =
	...
	//
	template <class F, class... Args>
	STL2_CONCEPT_KEYWORD RegularInvocable =
		Invocable<F, Args...>;
	...
	//
	template <class F, class... Args>
	STL2_CONCEPT_KEYWORD Predicate =
	...
	//
	template <class R, class T, class U>
	STL2_CONCEPT_KEYWORD StrictWeakOrder =
		Relation<R, T, U>;
