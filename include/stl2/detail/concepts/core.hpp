...
STL2_OPEN_NAMESPACE {
	...
	STL2_CONCEPT_KEYWORD _Valid = requires { typename T<U...>; };
	...
	STL2_CONCEPT_KEYWORD _Is = _Valid<T, U, V...> && __bool<T<U, V...>::value>;

	template <class U, template <class...> class T, class... V>
	STL2_CONCEPT_KEYWORD _IsNot = _Valid<T, U, V...> && __bool<!T<U, V...>::value>;

	// U is a cv/ref-qualified specialization of class template T.
	template <class U, template <class...> class T>
	STL2_CONCEPT_KEYWORD _SpecializationOf = __bool<meta::is<__uncvref<U>, T>::value>;
#else
	template <class U, template <class...> class T, class... V>
	STL2_CONCEPT_KEYWORD _Is = _Valid<T, U, V...> && T<U, V...>::value;

	template <class U, template <class...> class T, class... V>
	STL2_CONCEPT_KEYWORD _IsNot = _Valid<T, U, V...> && !T<U, V...>::value;

	// U is a cv/ref-qualified specialization of class template T.
	template <class U, template <class...> class T>
	STL2_CONCEPT_KEYWORD _SpecializationOf = meta::is<__uncvref<U>, T>::value;
#endif
	...
	template <class T>
	STL2_CONCEPT_KEYWORD _Decayed = Same<T, std::decay_t<T>>;

	template <class T, class... Args>
	STL2_CONCEPT_KEYWORD _OneOf = (Same<T, Args> || ...);

	template <class T, class U>
	STL2_CONCEPT_KEYWORD _NotSameAs = !_SameImpl<__uncvref<T>, __uncvref<U>>;

	///////////////////////////////////////////////////////////////////////////
	// DerivedFrom
	//
	template <class T, class U>
	STL2_CONCEPT_KEYWORD DerivedFrom =
#if defined(__GNUC__)
		__is_base_of(U, T) &&
#else
